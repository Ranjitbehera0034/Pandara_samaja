...
import { LogOut, LayoutDashboard, Users, Heart, Megaphone, Film, ShieldAlert, Calendar, UsersRound, BellRing, Settings, FileClock, Languages, Moon, Sun, X, Shield, Globe, Wallet, Video, BarChart } from 'lucide-react';
            ...
            <div className="flex-1 overflow-y-auto overflow-x-hidden scrollbar-thin scrollbar-thumb-slate-200 dark:scrollbar-thumb-slate-700">
                <nav className="flex flex-col py-4 space-y-1">
                    ...
                    <NavLink to="/video-analytics" className={linkClasses} onClick={handleLinkClick}>
                        <div className="shrink-0 px-2 flex justify-center w-10"><BarChart size={20} /></div>
