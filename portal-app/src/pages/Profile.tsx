...
export default function Profile() {
    ...
    const handlePhotoUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            ...
            const response = await fetch(`${API_BASE_URL}/members/${member?._id || member?.id}/photo`, {
                method: 'POST',
                    ...
                    <div className="flex flex-col md:flex-row items-start gap-6">
                        ...
                        <div className="relative -mt-20 md:-mt-24 group">
                            ...
                            <button
                                ...
                                className="absolute bottom-1 right-1 p-2 bg-blue-600 hover:bg-blue-500 rounded-full text-white shadow-lg opacity-0 group-hover:opacity-100 transition-opacity"
                            >
                                <Camera size={16} />
                            </button>
