    ...
    return (
        <AnimatePresence>
            {isVisible && (
                ...
                >
                    <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl shadow-2xl p-6 shadow-blue-500/10">
                        <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed mb-4">
                                    We use cookies to improve your experience and protect member PII. By using our platform, you agree to our <a href="https://nikhilaodishapandarasamaja.in/privacy.html" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 font-semibold hover:underline">Privacy Policy</a>.
                                </p>
